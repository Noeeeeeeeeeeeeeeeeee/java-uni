 ...
 * @author linoc
 */
public class CercaStudente extends javax.swing.JFrame {

    /**
     * Creates new form CercaStudente
     */
    public CercaStudente() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Studente s=g.cercaStudente(codice);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CercaStudente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CercaStudente().setVisible(true);
            }
        });
    }
