 ...
 * @author linoc
 */
public class CercaDisciplina extends javax.swing.JFrame {

    /**
     * Creates new form CercaDisciplina
     */
    public CercaDisciplina() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Disciplina d=g.cercaDisciplina(codice);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CercaDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CercaDisciplina().setVisible(true);
            }
        });
    }
