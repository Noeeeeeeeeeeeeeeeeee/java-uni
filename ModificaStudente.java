 ...
 * @author linoc
 */
public class ModificaStudente extends javax.swing.JFrame {

    /**
     * Creates new form ModificaStudente
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String corso = CorsoField.getText();
        ...
        g.modificaNomeStudente(matricola, nome);
        g.modificaCognomeStudente(matricola, cognome);
        g.modificaCorsoStudente(matricola, corso);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificaStudente().setVisible(true);
            }
        });
    }
