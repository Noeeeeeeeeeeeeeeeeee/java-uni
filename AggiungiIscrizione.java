 ...
 * @author linoc
 */
public class AggiungiIscrizione extends javax.swing.JFrame {

    /**
     * Creates new form AggiungiIscrizione
     */
    public AggiungiIscrizione() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ID Appello (deve esistere)");

        jLabel2.setText("Matricola Studente (deve esistetere)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        g.aggiungiIscrizioneAppello(id,matricola);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AggiungiIscrizione.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AggiungiIscrizione().setVisible(true);
            }
        });
    }
