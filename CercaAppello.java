 ...
 * @author linoc
 */
public class CercaAppello extends javax.swing.JFrame {

    /**
     * Creates new form CercaAppello
     */
    public CercaAppello() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Appello a=g.cercaAppello(codice);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CercaAppello.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CercaAppello().setVisible(true);
            }
        });
    }
