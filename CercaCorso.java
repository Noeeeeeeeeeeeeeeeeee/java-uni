 ...
 * @author linoc
 */
public class CercaCorso extends javax.swing.JFrame {

    /**
     * Creates new form CercaCorso
     */
    public CercaCorso() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CercaCorso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CercaCorso().setVisible(true);
            }
        });
    }
